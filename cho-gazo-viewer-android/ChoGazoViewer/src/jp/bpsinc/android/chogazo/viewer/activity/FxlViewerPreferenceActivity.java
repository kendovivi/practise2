...
public class FxlViewerPreferenceActivity extends ViewerPreferenceActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.cho_gazo_viewer_fxl_pref);

        mOrientationPreference = (ListPreference) findPreference(
                getString(R.string.pre_key_viewer_orientation));
        mSpreadPreference = (CheckBoxPreference) findPreference(
